...
export default function Hero({
  ...
  // v27.3.1: dropped the lg+ min-h. After v27.3.0 shrunk the desktop
  // logo, the lg:56vh min-height kept the hero block tall, which kept
  // the login form pushed below the fold. Mobile / sm preserved so the
  // marketing hero still reads as a proper banner on phone. md+ now
  // hugs its content, letting the form pull up.
  return (
    <section className="bb-hero relative flex flex-col items-center justify-center text-center px-6 pt-6 pb-10 sm:pt-10 sm:pb-12 min-h-[52vh] sm:min-h-[58vh] md:min-h-0 overflow-hidden">
